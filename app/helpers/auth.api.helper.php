...
function base64url_encode($data) {
    return rtrim(strtr(base64_encode($data), '+/', '-_'), '='); //codificar los datos pasados
}
 ...
 class AuthHelper {
    ...
    function createToken($payload) {
        ...
        $payload['exp'] = time() + JWT_EXP; //fecha vencimiento
    ...
    function currentUser() {
        ...
        return $this->verifyToken($auth[1]); //si esta OK devuelve payload
    }
